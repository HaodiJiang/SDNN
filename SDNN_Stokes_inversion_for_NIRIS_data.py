...
def save_results(predict_results, output_path, time_stamp, save_mag_field_o):
...
if __name__ == '__main__':
    model = load_model()
    # input data path
    input_path = 'inputs'  # edit your data path
    # inputs path
    ...
    for file in os.listdir(input_path):
        ...
        save_results(predict_results, output_path, file[: file.find('.')], save_mag_field_o=False)
